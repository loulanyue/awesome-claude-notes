...
- `awesome-claude-notes` — Self-referential ECC skill (#335)
...
- Added an AI-readable `llms.txt` entry point and CI validation for every declared npm
  publish and executable path.
