...
This guide helps you migrate from Claude Code to OpenCode while using the awesome claude notes (ECC) configuration.
...
- **ECC Configuration**: Report to [github.com/loulanyue/awesome-claude-notes](https://github.com/loulanyue/awesome-claude-notes)
