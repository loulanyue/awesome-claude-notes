...
```bash
gh api repos/loulanyue/awesome-claude-notes \
...
```bash
gh api repos/loulanyue/awesome-claude-notes/traffic/views
gh api repos/loulanyue/awesome-claude-notes/traffic/clones
```
