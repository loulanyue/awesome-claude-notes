...
Kısa ve uzun kılavuzlarda ele alınan her şey GitHub'da mevcuttur: `github.com/loulanyue/awesome-claude-notes`
...
Bu hook'ları oluşturdum ve repo'da `github.com/loulanyue/awesome-claude-notes/tree/main/hooks/memory-persistence` adresindeler
...
Bunu yapan bir sürekli öğrenme skill'i oluşturdum: `github.com/loulanyue/awesome-claude-notes/tree/main/skills/continuous-learning`
