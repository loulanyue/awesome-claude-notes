...
```bash
# 1. Fork ve clone
gh repo fork loulanyue/awesome-claude-notes --clone
...
- **Issue'lar:** [github.com/loulanyue/awesome-claude-notes/issues](https://github.com/loulanyue/awesome-claude-notes/issues)
