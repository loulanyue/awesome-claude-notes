...
<img src="../../assets/images/guides/shorthand-guide.png" alt="awesome claude notes Kısa Rehberi" />
</a>
</td>
<td width="33%">
<a href="https://x.com/affaanmustafa/status/2014040193557471352">
<img src="../../assets/images/guides/longform-guide.png" alt="awesome claude notes Uzun Rehberi" />
</a>
</td>
<td width="33%">
...
[Tam değişiklik günlüğü için Releases bölümüne bakın](https://github.com/loulanyue/awesome-claude-notes/releases).
...
/awesome-claude-notes:plan "Kullanıcı kimlik doğrulaması ekle"
...
|---------------------|---------------------|------------------|
| Yeni bir feature planla | `/awesome-claude-notes:plan "Auth ekle"` | planner |
| Sistem mimarisi tasarla | `/awesome-claude-notes:plan` + architect agent | architect |
...
```
/awesome-claude-notes:plan "OAuth ile kullanıcı kimlik doğrulaması ekle"
...
Bu en yaygın sorundur. `.claude-plugin/plugin.json`'a bir `"hooks"` alanı **EKLEMEYİN**. Claude Code v2.1+ kurulu plugin'lerden `hooks/hooks.json`'ı otomatik olarak yükler. Açıkça belirtmek duplicate algılama hatalarına neden olur. Bkz. [#29](https://github.com/loulanyue/awesome-claude-notes/issues/29), [#52](https://github.com/loulanyue/awesome-claude-notes/issues/52), [#103](https://github.com/loulanyue/awesome-claude-notes/issues/103).
</details>
...
- **Codex**: macOS app ve CLI için birinci sınıf destek. PR [#257](https://github.com/loulanyue/awesome-claude-notes/pull/257)'ye bakın.
