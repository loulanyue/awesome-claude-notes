...
<img src="https://github.com/user-attachments/assets/1a471488-59cc-425b-8345-5245c7efbcef" alt="awesome claude notes 簡明指南" />
</a>
</td>
<td width="50%">
<a href="https://x.com/affaanmustafa/status/2014040193557471352">
<img src="https://github.com/user-attachments/assets/c9ca43bc-b149-427f-b551-af6840c368f0" alt="awesome claude notes 完整指南" />
</a>
</td>
</tr>
<tr>
...
# 複製規則（應用於所有專案）
cp -r awesome-claude-notes/rules/* ~/.claude/rules/
```
...
```bash
# 嘗試一個指令（外掛安裝使用命名空間形式）
/awesome-claude-notes:plan "新增使用者認證"
...
# 複製規則
cp awesome-claude-notes/rules/*.md ~/.claude/rules/
...
- **簡明指南（從這裡開始）：** [awesome claude notes 簡明指南](https://x.com/affaanmustafa/status/2012378465664745795)
- **完整指南（進階）：** [awesome claude notes 完整指南](https://x.com/affaanmustafa/status/2014040193557471352)
