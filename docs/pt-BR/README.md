...
<img src="../../assets/images/guides/shorthand-guide.png" alt="The Shorthand Guide to awesome claude notes" />
</a>
</td>
<td width="33%">
<a href="https://x.com/affaanmustafa/status/2014040193557471352">
<img src="../../assets/images/guides/longform-guide.png" alt="The Longform Guide to awesome claude notes" />
</a>
</td>
<td width="33%">
...
/awesome-claude-notes:plan "Adicionar autenticação de usuário"
...
> cp -r awesome-claude-notes/rules/typescript/* ~/.claude/rules/   # escolha sua stack
>
...
cp -r awesome-claude-notes/.agents/skills/* ~/.claude/skills/
```
...
|----------|-----------------|--------------|
| Planejar um novo recurso | `/awesome-claude-notes:plan "Adicionar auth"` | planner |
| Projetar arquitetura de sistema | `/awesome-claude-notes:plan` + agente architect | architect |
...
```
/awesome-claude-notes:plan "Adicionar autenticação de usuário com OAuth"
