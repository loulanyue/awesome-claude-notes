...
Common issues and solutions for awesome claude notes (ECC) plugin.
...
# Claude Code → Extensions → awesome claude notes → Uninstall
...
cp -r awesome-claude-notes ~/.claude/plugins/ecc
```
...
cd ~/.claude/plugins/cache/awesome-claude-notes
npm install
...
1. **Check GitHub Issues**: [github.com/loulanyue/awesome-claude-notes/issues](https://github.com/loulanyue/awesome-claude-notes/issues)
...
## Fonte canônica
- [Documento original em inglês](../../TROUBLESHOOTING.md)
