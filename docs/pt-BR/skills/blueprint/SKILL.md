...
This skill ships with awesome claude notes. No separate installation is needed when ECC is installed.
...
```bash
cd /path/to/awesome-claude-notes
...
## Fonte canônica
- [Documento original em inglês](../../../../skills/blueprint/SKILL.md)
