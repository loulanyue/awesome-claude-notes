...
The Bad Rudi exploit video is no longer bundled in this repo, but the example still illustrates the same class of issue: repeated prompt attempts, eventual sensitive disclosure, and how much worse that becomes once real tools and permissions are attached.
...
> [The Shorthand Guide to awesome claude notes](https://x.com/affaanmustafa/status/2012378465664745795)

> [The Longform Guide to awesome claude notes](https://x.com/affaanmustafa/status/2014040193557471352)
...
## Fonte canônica
- [Documento original em inglês](../../the-security-guide.md)
