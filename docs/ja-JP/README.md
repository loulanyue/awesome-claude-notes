**言語:** [English](../../README.md) | [简体中文](../../README.zh-CN.md) | [繁體中文](../zh-TW/README.md) | [日本語](README.md) | [한국어](../ko-KR/README.md)
...
<img src="https://github.com/user-attachments/assets/1a471488-59cc-425b-8345-5245c7efbcef" alt="The Shorthand Guide to awesome claude notes" />
</a>
</td>
<td width="50%">
<a href="https://x.com/affaanmustafa/status/2014040193557471352">
<img src="https://github.com/user-attachments/assets/c9ca43bc-b149-427f-b551-af6840c368f0" alt="The Longform Guide to awesome claude notes" />
</a>
</td>
</tr>
<tr>
...
- **instinctインポート時のコンテンツ喪失を修正** — `/instinct-import`実行時に`parse_instinct_file()`がfrontmatter後のすべてのコンテンツ（Action、Evidence、Examplesセクション）を暗黙的に削除していた問題を修正。コミュニティ貢献者@ericcai0814により解決されました（[#148](https://github.com/loulanyue/awesome-claude-notes/issues/148), [#161](https://github.com/loulanyue/awesome-claude-notes/pull/161)）
...
完全なチェンジログは[Releases](https://github.com/loulanyue/awesome-claude-notes/releases)を参照してください。
...
cp -r awesome-claude-notes/rules/python/* ~/.claude/rules/
cp -r awesome-claude-notes/rules/golang/* ~/.claude/rules/
```
...
/awesome-claude-notes:plan "ユーザー認証を追加"
...
**背景:** これは本リポジトリで複数の修正/リバート循環を引き起こしました（[#29](https://github.com/loulanyue/awesome-claude-notes/issues/29), [#52](https://github.com/loulanyue/awesome-claude-notes/issues/52), [#103](https://github.com/loulanyue/awesome-claude-notes/issues/103)）。Claude Codeバージョン間で動作が変わったため混乱がありました。今後を防ぐため回帰テストがあります。
...
```json
{
  ...
  "enabledPlugins": {
    "awesome-claude-notes@awesome-claude-notes": true
  }
}
```
...
> cp -r awesome-claude-notes/rules/common/* ~/.claude/rules/
> cp -r awesome-claude-notes/rules/typescript/* ~/.claude/rules/   # スタックを選択
> cp -r awesome-claude-notes/rules/python/* ~/.claude/rules/
> cp -r awesome-claude-notes/rules/golang/* ~/.claude/rules/
>
...
Cursor 向けの詳細ドキュメントは現在このリポジトリには同梱されていないため、このセクションと `./install.sh --target cursor ...` を基準に利用してください。
...
- **簡潔ガイド（まずはこれ）:** [awesome claude notes 簡潔ガイド](https://x.com/affaanmustafa/status/2012378465664745795)
- **詳細ガイド（高度）:** [awesome claude notes 詳細ガイド](https://x.com/affaanmustafa/status/2014040193557471352)
