...
전체 변경 내역은 [Releases](https://github.com/loulanyue/awesome-claude-notes/releases)에서 확인하세요.
...
/awesome-claude-notes:plan "사용자 인증 추가"
...
> cp -r awesome-claude-notes/rules/typescript/* ~/.claude/rules/   # 사용하는 스택 선택
>
...
cp -r awesome-claude-notes/skills/search-first ~/.claude/skills/
```
...
|-------------|-------------|-----------------|
| 새 기능 계획하기 | `/awesome-claude-notes:plan "인증 추가"` | planner |
| 시스템 아키텍처 설계 | `/awesome-claude-notes:plan` + architect 에이전트 | architect |
...
**새로운 기능 시작:**
```
/awesome-claude-notes:plan "OAuth를 사용한 사용자 인증 추가"
                                              → planner가 구현 청사진 작성
...
- **요약 가이드 (여기서 시작):** [The Shorthand Guide to awesome claude notes](https://x.com/affaanmustafa/status/2012378465664745795)
- **상세 가이드 (고급):** [The Longform Guide to awesome claude notes](https://x.com/affaanmustafa/status/2014040193557471352)
